...
{
    internal partial class HWordVisitEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            var runtimeEntityType = model.AddEntityType(
                "Anf.ChannelModel.Entity.HWordVisit",
                typeof(HWordVisit),
                baseEntityType);
        ...
        public static RuntimeForeignKey CreateForeignKey2(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
        {
            ...
            var visits = principalEntityType.AddNavigation("Visits",
                runtimeForeignKey,
                onDependent: false,
                typeof(IEnumerable<HWordVisit>),
                propertyInfo: typeof(HWord).GetProperty("Visits", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
                fieldInfo: typeof(HWord).GetField("<Visits>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
